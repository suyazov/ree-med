...
$default_included_cards = array(
    ...
    array('image' => $img_dir . '/laboratory-included-6.png', 'number' => '5', 'title' => 'Консультации по эксплуатации'),
    array('image' => $img_dir . '/laboratory-included-5.png', 'number' => '6', 'title' => 'Сервисное сопровождение'),
);
