    ...
    <div class="lab-container">
        <div class="lab-hero-grid">
            <div class="lab-hero-left">
                <h1 class="lab-hero-title"><?php echo esc_html($hero_title); ?></h1>
                <p class="lab-hero-desc"><?php echo esc_html($hero_desc); ?></p>

                <div class="lab-hero-features">
                    <div class="lab-hero-feature-card"><span class="check"></span><span>Безопасность лаборатории</span></div>
                    <div class="lab-hero-feature-card"><span class="check"></span><span>Расчёт под объём исследований</span></div>
                    <div class="lab-hero-feature-card"><span class="check"></span><span>Учёт бюджета</span></div>
                    <div class="lab-hero-feature-card"><span class="check"></span><span>Подбор под задачи учреждения</span></div>
                </div>

                <div class="lab-hero-btns">
                    <button class="lab-hero-btn lab-hero-btn--primary" type="button"><?php echo esc_html($hero_btn); ?></button>
                    <button class="lab-hero-btn lab-hero-btn--secondary" type="button">Подобрать оборудование</button>
                </div>
            </div>
            ...
            <div class="lab-hero-right">
                ...
                <div class="lab-hero-badges">
                    <div class="lab-hero-badge-glass">
                    ...
                    <div class="lab-hero-badge-green">
                        <span class="txt">Поставка со склада и под заказ</span>
                    </div>
                    <div class="lab-hero-badge-green lab-hero-badge-green--alt">
                        <span class="txt">Оборудование ведущих производителей</span>
                    </div>
                    <div class="lab-hero-badge-green lab-hero-badge-green--alt">
                        <span class="txt">Сервисное сопровождение</span>
                    </div>
                </div>
            </div>
        </div>
...
<section class="lab-audience">
    <div class="lab-section-inner">
        <div class="lab-audience-header">
            ...
            <h2 class="lab-audience-title">Решения для разных типов лабораторий</h2>
        </div>

        <div class="lab-audience-grid">
            <div class="lab-audience-card lab-audience-card--green"><span class="arrow arrow--tr"></span><p class="text">Клинико-диагностические лаборатории</p></div>
            <div class="lab-audience-card lab-audience-card--white"><span class="arrow arrow--tr"></span><p class="text">Лаборатории медицинских центров</p></div>
            <div class="lab-audience-card lab-audience-card--gray"><span class="arrow arrow--br"></span><p class="text">Научно-исследовательские лаборатории</p></div>
            <div class="lab-audience-card lab-audience-card--image"><span class="arrow arrow--br"></span><p class="text">Ветеринарные лаборатории</p></div>
            <div class="lab-audience-card lab-audience-card--white"><span class="arrow arrow--tr"></span><p class="text">Государственные учреждения</p></div>
            <div class="lab-audience-card lab-audience-card--green"><span class="arrow arrow--tr"></span><p class="text">Производственные лаборатории</p></div>
        </div>
    </div>
</section>
